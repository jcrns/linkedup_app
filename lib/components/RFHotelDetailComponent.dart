...
class RFHotelDetailComponent extends StatelessWidget {
  ...
  RFHotelDetailComponent({this.hotelData, RoomFinderModel? eventData});
      ...
      children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    8.height,
                    Text('Los Angeles, Chicago', style: primaryTextStyle()),
                    8.height,
                    Row(
        ...
        Column(
          ...
          children: [
            ...
            8.height,
            Text(
              '1 big hall room for rent at Chicago, ktm with the facilities of bike parking and tap water . it offers 1 bedroom,and a 1 common bathroom for whole flat. It is suitable for student only. Price is negotiable for student only. ',
