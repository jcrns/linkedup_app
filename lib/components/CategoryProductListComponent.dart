...
class CategoryProductListComponent extends StatelessWidget {
  final Product? productData;
  final bool? showHeight;

  CategoryProductListComponent({this.productData, this.showHeight});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          rfCommonCachedNetworkImage(productData?.img, height: 100, width: 100, fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
          16.width,
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(productData!.title.validate(), style: boldTextStyle()),
                      8.height,
                      Row(
                        children: [
                  ...
                  Row(
                    children: [
                      ...
                      6.width,
                      // Text(productData!.address.validate(), style: secondaryTextStyle()),
                    ],
                  ),
                ],
              ).paddingOnly(left: 3),
              ...
              Row(
                children: [
                  ...
                  6.width,
                  Text(productData!.description.validate(), style: secondaryTextStyle()),
                ],
              ),
            ],
          ).expand()
      ...
      // RFEventDescriptionScreen(productData: productData).launch(context);
