        ...
        subWidget: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Balance: \$100', style: secondaryTextStyle()),
                8.width,
                Container(height: 10, width: 1, color: appStore.isDarkModeOn ? white : gray.withOpacity(0.4)),
                8.width,
                Text('5 Vouchers Available', style: secondaryTextStyle()),
              ],
            ),
            32.height,
            Row(
                ...
                OutlinedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // 8.width,
                      Text('Withdraw', style: boldTextStyle(color: appStore.isDarkModeOn ? white : rf_primaryColor)),
                    ],
                  ),
                ).expand(),
                16.width,
                AppButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // 8.width,
                      Text('Add Funds', style: boldTextStyle(color: white)),
                    ],
                  ),
                  onTap: () {
